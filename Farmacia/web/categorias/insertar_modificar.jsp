...
<div class="contenedor">
    <div class="col-6 col-t-12">
        <form name="form_categoria" onsubmit="return validar();" action="${pageContext.servletContext.contextPath}/Categorias?accion=insertar_modificar" method="POST">
            <h1>Categorias</h1>
            <h2>Complete la informacion</h2><br/><br/>
            <div class="form-group">
                <label for="formGroupExampleInput">Id Categoria :</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="txtcategoria" value="${Categoria.getIdCategoria()}" readonly="readonly">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Nombre Categoria:</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="txtnombre" id="txtnombre" value="${Categoria.getNombre()}">
            </div>
            <br/>
            <div class="buttons">
