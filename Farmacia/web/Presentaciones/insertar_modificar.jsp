    ...
    <div class="col-6 col-t-12">
        ...
        <form name="form_presentacion" onsubmit="return validar();" action="${pageContext.servletContext.contextPath}/Presentaciones?accion=insertar_modificar" method="POST">
            ...
            <div class="form-group">
                <label for="formGroupExampleInput">Id Presentación :</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="txtpresentacion" value="${Presentaciones.getIdPresentacion()}" readonly="readonly">
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Nombre Presentción:</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="txtnombre" id="txtnombre" value="${Presentaciones.getNombre()}">
            </div>
            <br/>
            <div class="buttons">
