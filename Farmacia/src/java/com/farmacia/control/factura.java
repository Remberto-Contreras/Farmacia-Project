...
import com.farmacia.entidad.Factura;
        ...
        if (accion == null) {
            ...
            try {
                ...
                if (request.getParameter("txtBusqueda") != null) {
                    sql = "select * from Factura where Nombre like ?";
                } else {
                ...
                if (request.getParameter("txtBusqueda") != null) {
                    ...
                    fac = Operaciones.consultar(sql, params);
                } else {
                    fac = Operaciones.consultar(sql, null);
                }
//declaracion de cabeceras a usar en la tabla HTML
                String[] cabeceras = new String[]{
                    ...
                    "ID Tipo de Documentto"
                    
                    

                };
//variable de tipo Tabla para generar la Tabla HTML
                Tabla tab = new Tabla(fac, //array que contiene los datos
...
//pagina encargada de eliminar
                tab.setPaginaEliminable("/Factura?accion=eliminar");
//pagina encargada de actualizacion
                tab.setPaginaModificable("/Factura?accion=modificar");
//pagina encargada de seleccion para operaciones
                tab.setPaginaSeleccionable("/Factura?accion=modificar");
...
//imprime la tabla en pantalla
                ...
                request.getRequestDispatcher("categoria/categoria_consulta.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
