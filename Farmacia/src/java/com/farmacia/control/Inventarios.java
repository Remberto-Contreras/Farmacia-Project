...
//        }
        ...
        if(accion==null) {
            ...
            try {
                ...
                if(request.getParameter("txtBusqueda")!=null) {
                    ...
                    sql = "select \n" +
                          ...
                          "(select Categoria from Nombre where IdCategoria = p.IdCategoria) as Categoria\n" +
                            "(select Presentaciones from Nombre where IdPresentacion = p.IdPresentacion) as Presentaciones\n" +
                          " from Inventario p";
                }
            ...
            try {
                ...
                String[][] presentacion = Operaciones.consultar(sql, null);
                //declaracion de cabeceras a usar en la tabla HTML
                String[] cabeceras = new String[]{
                    "Id Presentacion",
                    "Presentacion"
            ...
            case "insertar_modificar": {
                ...
                try {
                    ...
                    if (idProducto != null && !idProducto.equals("")) {
                        inventario p = new inventario(Integer.parseInt(idProducto), nombre,Float.parseFloat(precio),fecha,Integer.parseInt(idCategoria),Integer.parseInt(idPresentacion));
